...
curl -s -o /dev/null -w "%{http_code}" http://localhost:5001/health/ready
echo ""
...
HTTP_STATUS=$(curl -s -o /dev/null -w "%{http_code}" -H "Accept: text/html" http://localhost:5001/graphql/)
...
echo "  - Root: http://localhost:5001/"
echo "  - GraphQL API: http://localhost:5001/graphql"
echo "  - GraphQL IDE: http://localhost:5001/graphql/ (Banana Cake Pop)"
echo "  - Health Check: http://localhost:5001/health"
echo "  - Health Ready: http://localhost:5001/health/ready"
echo "  - Health Live: http://localhost:5001/health/live"